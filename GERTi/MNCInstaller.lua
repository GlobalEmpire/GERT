...
shell.execute("wget https://raw.githubusercontent.com/GlobalEmpire/GERT/master/GERTi/MNCAPI.lua /lib/GERTiClient.lua -f")
shell.execute("wget https://raw.githubusercontent.com/GlobalEmpire/GERT/master/GERTi/Modules/DNS.lua /etc/rc.d/DNS.lua -f")
shell.execute("wget https://raw.githubusercontent.com/GlobalEmpire/GERT/master/GERTi/RecommendedConfig-GUSs.cfg /etc/GERTUpdateServer.cfg")
